ALTER TABLE LIVESCREEN.SMSCB_MESSAGE_RESULT
 DROP PRIMARY KEY CASCADE;

DROP TABLE LIVESCREEN.SMSCB_MESSAGE_RESULT CASCADE CONSTRAINTS;

CREATE TABLE LIVESCREEN.SMSCB_MESSAGE_RESULT
(
  MSG_SEQ_ID            VARCHAR2(100 CHAR)      NOT NULL,
  MESSAGE_ID            VARCHAR2(100 CHAR),
  CBM_ID                VARCHAR2(100 CHAR),
  ZONE_ID               NUMBER(15),
  SCHEDULE_ID           VARCHAR2(100 CHAR),
  DURATION              NUMBER(15),
  WAIT_TO_BROADCAST     NUMBER(15),
  REPETITION_RATE       NUMBER(9),
  BROADCAST_CHANNEL     NUMBER(9),
  DCS                   VARCHAR2(20 CHAR),
  ENCODING_RULE         VARCHAR2(20 CHAR),
  DATA                  VARCHAR2(2000 CHAR),
  START_TIME            TIMESTAMP(6),
  END_TIME              TIMESTAMP(6),
  SUMMITTED_TIME        TIMESTAMP(6),
  BROADCAST_STATE_CODE  NUMBER(5),
...
PARTITION BY RANGE (SUMMITTED_TIME)
(  
...
CREATE UNIQUE INDEX LIVESCREEN.SMSCB_MESSAGE_RESULT_PK ON LIVESCREEN.SMSCB_MESSAGE_RESULT
(MSG_SEQ_ID)
LOGGING
TABLESPACE TBS_KPI
PCTFREE    10
...
CREATE OR REPLACE PUBLIC SYNONYM SMSCB_MESSAGE_RESULT FOR LIVESCREEN.SMSCB_MESSAGE_RESULT;


ALTER TABLE LIVESCREEN.SMSCB_MESSAGE_RESULT ADD (
  CONSTRAINT SMSCB_MESSAGE_RESULT_PK
  PRIMARY KEY
  (MSG_SEQ_ID)
  USING INDEX LIVESCREEN.SMSCB_MESSAGE_RESULT_PK
  ENABLE VALIDATE);
